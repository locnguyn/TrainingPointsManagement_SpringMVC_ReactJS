...
public class ApiActivityController {
    ...
    @CrossOrigin
    @GetMapping("/{id}")
    public ResponseEntity<ActivityDTO> activiyDetails(@PathVariable(value = "id") Integer id){
        
        return new ResponseEntity<>(this.acService.getActivityByIdDTO(id), HttpStatus.OK);
    }
    ...
    public ResponseEntity<CommentDTO> addComment(@PathVariable(value = "id") Integer id, @RequestBody Map<String, String> params, Principal p){
        ...
        this.coService.save(c);
        
        return new ResponseEntity<>(this.coService.convertToDTO(c), HttpStatus.CREATED);
    }
}
