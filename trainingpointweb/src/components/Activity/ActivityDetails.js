...
const ActivityDetails = () => {
  ...
  const deleteComment = async (commentId) => {
    try {
      const res = await authApi().delete(endpoints['delete-comment'](commentId));
      if (res.status === 200) {
  ...
  const updateComment = async (commentId, content) => {
    try {
      // const res = await toast.promise(authApi().patch(endpoints['update-comment'](commentId), {
      //   content: content
      // }), {
      //   loading: 'Đang cập nhật',
      //   success: <b>Cập nhật bình luận thành công!</b>,
      //   error: <b>Cập nhật bình luận thất bại!</b>,
      // })
      const res = await authApi().patch(endpoints['update-comment'](commentId), {
        content: content
      });
      if (res.status === 200) {
  ...
  return (
    ...
    <>
      ...
      <div className="row">
        <div className="mb-2 d-flex justify-content-between" style={{ color: "#666" }}>
          <span>
            {activity.likes != 0 ? <div className='align-self-end' ><small>
              ...
              <small className="ms-1" style={{ fontSize: "16px" }}>{activity.likes != 1 ? activity.likes : ""}</small></div>
              : <></>}
          </span>
          <span>
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" className="bi bi-chat-fill">
        ...
        <div className="">
          <button className={activity.liked ? "btn btn-primary" : "btn border border-2"} onClick={likeOrUnlike}>
            {activity.liked ? <><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" className="bi bi-hand-thumbs-up-fill">
            ...
            </svg> Đã thích</> : <><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" className="bi bi-hand-thumbs-up">
      ...
      <div className="mt-4">
        <h3>Bình luận</h3>
        <CommentList comments={comments} handleDelete={deleteComment} handleUpdate={updateComment} />
      </div>
